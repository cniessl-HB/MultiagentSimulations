...
def test_history_invalid_comparison() -> None:
    ...
    fake_log_entry = base_log_entry(sim_name, agent_name, 0, "Actual Log")
...
def test_history_same_step_ordering() -> None:
    ...
    fake_log_entry_first = base_log_entry(sim_name, agent_name, 0, "Earliest Log")
    fake_log_entry_second = base_log_entry(sim_name, agent_name, 0, "Earliest Log")
...
def test_history_diff_step_ordering() -> None:
    ...
    fake_log_entry_first = base_log_entry(sim_name, agent_name, 0, "Earliest Log")
    fake_log_entry_second = base_log_entry(sim_name, agent_name, 0, "Next Log")
...
def test_history_str_output() -> None:
    ...
    fake_log_entry = base_log_entry(agent_name1, agent_name2, 0, log_message)
