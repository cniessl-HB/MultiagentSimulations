...
class base_simulation(some_sim):
    ...
    def _gen_deact_history_stub(self, agent_to_deact: some_agent) -> None:
        ...
        stub_to_add: some_log = base_log_entry(
            self.sim_name, agent_to_deact.get_id(), self.sim_step, action_message
        )
